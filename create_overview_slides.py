...
add_bullet(tf1, "OTHER_EYE_DATA  \u2014  papers, reviews, borderline", size=14, level=1, color=LIGHT_GRAY)
...
add_bullet(tf3, "", size=6)
add_bullet(tf3, "OTHER_EYE_DATA: 79 examples", size=16, bold=True, color=ORANGE)
...
add_bullet(tf5, "OTHER_EYE_DATA:          3", size=18, bold=True, color=ORANGE)
...
add_bullet(tf7, "   OTHER_EYE_DATA boundary", size=14, level=1, color=LIGHT_GRAY)
add_bullet(tf7, "", size=8)
