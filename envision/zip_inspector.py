...
class ZenodoInspector:
    ...
    # =========================================================================
    def inspect_zip_via_range(self, filename: str, max_tail_bytes: int = 65536) -> Optional[list[dict]]:
        """
    ...
    def _parse_zip_central_directory(self, data: bytes) -> Optional[list[dict]]:
        ...
        try:
            ...
            if cd_start_in_chunk < 0:
                print(f"Central directory larger than downloaded chunk. Need more bytes.")
                return None
    ...
    # =========================================================================
    def download_and_list_zip(self, filename: str, max_size_mb: int = 100) -> Optional[list[dict]]:
        """
    ...
    if result["zip_contents"]:
        ...
        for zip_name, info in result["zip_contents"].items():
            ...
            if "summary" in info:
                ...
                print(f"    Files: {summary['total_files']}, Dirs: {summary['total_directories']}")
